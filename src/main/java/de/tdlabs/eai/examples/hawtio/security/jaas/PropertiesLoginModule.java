...
public class PropertiesLoginModule extends PropertiesLoader implements LoginModule {
    ...
    private static final String USER_FILE_PROP_NAME = "tdlabs.hawtio.jaas.properties.user";

    private static final String GROUP_FILE_PROP_NAME = "tdlabs.hawtio.jaas.properties.group";
