...
public class PropertiesLoader {
    ...
    public class FileNameKey {
        ...
        public FileNameKey(String nameProperty, String fallbackName, Map options) {
            this.file = new File(baseDir(options),
                    stringOption(nameProperty, fallbackName, options));
        ...
        public boolean equals(Object other) {
            return other instanceof FileNameKey
                    && this.absPath.equals(((FileNameKey) other).absPath);
        }
        ...
        private File baseDir(Map options) {
            ...
            if (options.get("baseDir") != null) {
                ...
                if (System.getProperty("java.security.auth.login.config") != null) {
                    baseDir = new File(System.getProperty("java.security.auth.login.config"))
                            .getParentFile();
                }
            }
            if (debug) {
